...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            ...
            StatusSurfacePreviewItem::ContextRemainingPercent => "0% left",
            ...
            StatusSurfacePreviewItem::QuotaSummary => "5h:87%(2h1m) wk:50%(5d22h)",
            StatusSurfacePreviewItem::SparkQuotaSummary => "sp:82%(5d12h)",
